...
* See the [root README](https://github.com/tnn-gruntwork-io/terraform-kubernetes-namespace/blob/main/README.md) for instructions on using Terraform modules.
...
* See the [examples](https://github.com/tnn-gruntwork-io/terraform-kubernetes-namespace/tree/main/examples) folder for example
  usage.
* See [variables.tf](https://github.com/tnn-gruntwork-io/terraform-kubernetes-namespace/blob/main/modules/namespace/variables.tf)
  for all the variables you can set on this module.
* See [outputs.tf](https://github.com/tnn-gruntwork-io/terraform-kubernetes-namespace/blob/main/modules/namespace/outputs.tf)
