...
func TestK8SNamespaceWithServiceAccountNoCreate(t *testing.T) {
	...
	k8sNamespaceTerraformModulePath := test_structure.CopyTerraformFolderToTemp(t, "..", ".")

	test_structure.RunTestStage(t, "create_terratest_options", func() {
		uniqueID := random.UniqueId()
		k8sNamespaceTerratestOptions := createExampleK8SNamespaceTerraformOptions(t, uniqueID, k8sNamespaceTerraformModulePath)
